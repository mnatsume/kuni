...
UPDATE [dbo].[JAPAN_VER80] SET KUNI = '甲斐国' WHERE KEN IN('山梨県')
UPDATE [dbo].[JAPAN_VER80] SET KUNI = '信濃国' WHERE KEN IN('長野県')
UPDATE [dbo].[JAPAN_VER80] SET KUNI = '佐渡国' WHERE KEN IN('新潟県') AND (SIKUCHOSON = '佐渡市')
UPDATE [dbo].[JAPAN_VER80] SET KUNI = '越後国' WHERE KEN IN('新潟県') AND KUNI IS NULL